...
def plot_confine_traces(combine, args, sorted_conditions):
    figncols = combine.get_num_conditions()
...
def plot_confine_times(combine, args, sorted_conditions, skip_high=0):
    ...
    data = {'condition':[],'time_in_area':[], 'percent_in_area':[]}
    ...
    for cond in sorted_conditions:
        ...
        for df in r['df']:
            ...
            if skip_high and (df['z'].head(10).mean() > skip_high):
                print "SKIP (too high)"
                continue
...
if __name__=='__main__':
    ...
    plot_confine_times(combine, args, sorted_conditions,skip_high=0.85)
