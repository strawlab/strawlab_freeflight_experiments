...
FLY_DIST_MIN_DIST   = 0.000005 # 0.0005   # minimum distance fly must move in above interval to not be ignored
...
#
CONDITIONS = [
              "infinity.svg/+5.0/0.1/+1.0/15.0",
              "infinity.svg/+5.0/0.1/+1.0/20.0",
]
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            with self.trackinglock:
                ...
                print "fly_z: ", fly_z, " fly_nr: ", currently_locked_obj_id 
