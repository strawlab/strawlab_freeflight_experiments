...
#
CONDITIONS = [
                "infinity03.svg/10.0/0.05/-1/5.0",
                "infinity03.svg/10.0/0.05/-1.0/20.0",
                "infinity03.svg/10.0/0.05/-1.0/35.0",
                "infinity03.svg/5.0/0.05/-1.0/5.0",
                "infinity03.svg/5.0/0.05/-1.0/20.0",
                "infinity03.svg/5.0/0.05/-1.0/35.0",
                "infinity03.svg/10.0/0.05/1/5.0",
                "infinity03.svg/10.0/0.05/1.0/20.0",
                "infinity03.svg/10.0/0.05/1.0/35.0",
                "infinity03.svg/5.0/0.05/1.0/5.0",
...
class Node(object):
    ...
    def switch_conditions(self,event,force=''):
        ...
        self.z_target = -0.02      #!!!z = 0 is surface
