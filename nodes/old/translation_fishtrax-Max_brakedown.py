...
Y_CENTER = 0
RADIUS = 21
Z_CENTER = -9+RADIUS  #waterlevel is at z=0, floor of the bowl at =-9, center of sphere is -9+RADIUS

# time interval in seconds to check fly movement after lock on
FLY_HEIGHT_CHECK_TIME = 5 #0.5       
...
#
CONDITIONS = [
              "infinity03.svg/+5.0/0.1/-1.0/18.0",
]
...
class Node(object):
    ...
    def switch_conditions(self,event,force=''):
        ...
        self.z_target = -0.05      #!!!z = 0 is surface
