...
class Node(object):
    ...
    def switch_conditions(self,event,force=''):
        ...
        #HACK
        self.pub_cyl_height.publish(np.abs(10*self.rad_locked))
        ...
        while not rospy.is_shutdown():
            ...
            if currently_locked_obj_id is None:
                ...
                if self.rad_locked > 0:
                    self.pub_cyl_centre.publish(fly_x,fly_y,-5.0)
                else:
                    self.pub_cyl_centre.publish(0,0,-5.0)
