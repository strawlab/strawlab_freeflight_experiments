...
SWITCH_MODE_TIME    = 10.0*60    #alternate between control and static (i.e. experimental control) seconds

ADVANCE_RATIO       = 1/100.0   #### ????? ####

FLY_DIST_CHECK_TIME = 2       # time interval in seconds to check fly movement
FLY_DIST_MIN_DIST   = 0.01   # swimm more than 0.5 cm/sec # minimum distance fly must move in above interval to not be ignored
...
# define bowl center = (x,y,z) = (0,0,0)

X_CENTER = 0
Y_CENTER = 0
RADIUS = 0.21
Z_CENTER = -0.09+RADIUS  #waterlevel is at z=0, floor of the bowl at =-9, center of sphere is -9+RADIUS
...
#
CONDITIONS = [
                "infinity04.svg/5.0/0.05/5/5.0",
                "infinity04.svg/5.0/0.05/5/10.0",
                "infinity04.svg/5.0/0.05/5/15.0",
                "infinity04.svg/5.0/0.05/5/20.0",
                "infinity04.svg/10.0/0.05/5/10.0",
                "infinity04.svg/20.0/0.05/5/10.0",
                "infinity04.svg/30.0/0.05/5/10.0"
]
...
class Node(object):
    ...
    def switch_conditions(self,event,force=''):
        ...
        self.z_target = -0.01    #!!!z = 0 is surface
