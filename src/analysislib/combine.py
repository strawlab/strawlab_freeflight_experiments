...
class CombineH5WithCSV(_Combine):
    ...
    def add_from_args(self, args, csv_suffix=None, frames_before=0, new=False):
    ...
    def add_csv_and_h5_file_old(self, csv_fname, h5_file, args, frames_before=0):
    ...
    def add_csv_and_h5_file_new(self, csv_fname, h5_file, args, frames_before=0):
        """Add a single csv and h5 file"""
        ...
        for (oid,cond),odf in csv.groupby(('lock_object','condition')):
            ...
            if frames_before != 0:
                start_frame = trial_framenumbers[0] - frames_before
            else:
            ...
            if df is not None:
                ...
                if self._index == 'framenumber':
                    ...
                    join_type = 'outer' if frames_before else 'inner'
                    df = pd.concat((
